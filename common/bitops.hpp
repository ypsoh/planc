#ifndef COMMON_BITOPS_HPP_
#define COMMON_BITOPS_HPP_
...
pdep(int x, unsigned __int128 y)
{
...
static inline int //__attribute__((target("bmi2")))
...
static inline int //__attribute__((target("default")))
pext(unsigned __int128 x, unsigned __int128 y)
{
  unsigned long long ylow = y & 0xffffffffffffffff;
  unsigned long long xlow = x & 0xffffffffffffffff;
